...
class CredentialManager
  constructor: (options, meshbluConfig) ->
    @credentialDeviceManager = new CredentialDeviceManager _.defaults({}, options, type: 'channel-credentials:octoblu'), meshbluConfig
    @userCredentialDeviceManager = new UserCredentialDeviceManager _.defaults({}, options, type: 'device-credentials:octoblu'), meshbluConfig
